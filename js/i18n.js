...
window.I18N = {
  ui: {
    en: {
      ...
      ht_all: "All",
      ht_try: "Try it",
      onb1_t: "Welcome to WebDev Academy! 👋",
      onb1_b: "Learn to code for free — in Burmese + English, right on your phone.",
      onb2_t: "Learn by doing",
      onb2_b: "Real lessons with code you can run and edit in place — plus quizzes and an AI tutor whenever you're stuck.",
      onb3_t: "Build a daily habit",
      onb3_b: "Earn XP, keep a streak 🔥, and let Daily Review bring lessons back so they truly stick.",
      onb4_t: "Earn a real certificate 🎓",
      onb4_b: "Finish a course to unlock your certificate. Ready to find where to start?",
      onb_goal_q: "How many lessons a week?",
      onb_next: "Next",
      onb_skip: "Skip",
      onb_cta_quiz: "Find my course (1-min quiz)",
      onb_cta_browse: "Browse all courses",
      ...
      pg_explain: "Explain this error",
      pg_explain_working: "Reading the error…",
      focus_mode: "Focus",
      focus_exit: "Exit focus",
      focus_hint: "Distraction-free reading (Esc to exit)",
      /* Grouped top-nav menus. Kept separate from page *_title keys so a
         heading can change without silently renaming a nav entry. */
      nm_learn: "Learn",
      nm_build: "Build",
      nm_community: "Community",
      nm_me: "Me",
      nm_courses: "Courses",
      nm_gallery: "Course Gallery",
      nm_roadmap: "Roadmap",
      nm_start: "Find My Course",
      nm_howto: "How-To",
      nm_daily: "Daily Challenge",
      nm_review: "Review & Flashcards",
      nm_playground: "Playground",
      nm_tools: "Tools",
      nm_notes: "My Notebook",
      nm_portfolio: "Portfolio",
      nm_cv: "CV Builder",
      nm_interview: "Mock Interview",
      nm_trending: "Trending",
      nm_chat: "Community Chat",
      nm_leaderboard: "Leaderboard",
      nm_battle: "Code Battle",
      nm_explore: "Explore Open Source",
      nm_mylearning: "My Learning",
      nm_recap: "Weekly Recap",
      nm_account: "Account",
      nm_premium: "Go Premium",
      nm_verify: "Verify a certificate",
      chat_search: "Search messages",
      chat_search_ph: "Search this room…",
      chat_search_clear: "Clear search",
      chat_search_n: "{n} found",
      chat_search_none: "No messages match",
      chat_save: "Save message",
      chat_unsave: "Remove from saved",
      chat_saved: "Saved messages",
      chat_saved_none: "Nothing saved yet — tap 🔖 on a message to keep it.",
      chat_more_menu: "More options",
      chat_close: "Close chat",
      chat_full: "Fullscreen",
      chat_full_exit: "Exit fullscreen",
      chat_online_n: "{n} online",
      ...
      tool_back: "← All tools",
      tool_cheats: "Cheat Sheets", tool_cheats_d: "HTML, CSS, JS, Python, Git, SQL, HTTP, Regex, Emmet & more — search any command, copy it in one tap.",
      cheat_search: "Filter this sheet…",
      cheat_matches: "matches",
      cheat_none: "No matches in this sheet.",
      ...
      tool_boxmodel: "Box Model Lab", tool_boxmodel_d: "See margin, border, padding and content as colors — drag the sliders and watch the box change instantly.",
      tl_bm_total: "Size on screen (width + padding + border)",
      ...
      cc_ai: "AI polish",
      aimg_title: "AI image",
      aimg_sub: "free — type an idea, get a picture (no key, no cost)",
      aimg_ph: "Describe a picture, e.g. a cartoon laptop learning to code",
      aimg_need: "Type a description first!",
      aimg_making: "Drawing your image… (a few seconds)",
      aimg_done: "Done — right-click / long-press to save",
      vid_thumb_ready: "thumbnail idea filled below — tap 🎨 Generate",
      ...
      proj_word: "Project",
      proj_submit: "Submit for review",
      proj_reviewing: "Your mentor is reviewing your code…",
      proj_feedback: "Mentor feedback",
      proj_saved: "Saved to your portfolio!",
      proj_saved_go: "See it in your portfolio",
      proj_pick: "Pick a project to build",
      proj_run: "Run",
      proj_edit: "Edit",
      course_project: "Build a project",
      portfolio_mine: "My Portfolio",
      portfolio_title: "Portfolio",
      portfolio_sub: "Real projects you built — proof of what you can do.",
      portfolio_share: "Share my portfolio",
      portfolio_empty: "No projects yet. Build your first one!",
      portfolio_empty_pub: "This portfolio is empty for now.",
      portfolio_start: "Start a project",
      showcase_title: "Showcase",
      showcase_sub: "Real projects built by students, just like you. Get inspired — then build yours.",
      showcase_build: "Build yours",
      showcase_browse: "Browse showcase",
      showcase_empty: "No projects shared yet. Be the first to submit one!",
      by_word: "by",
      trending_word: "Trending",
      newest_word: "Newest",
      chat_trending: "Trending",
      ...
      almost_n: "You are {n} lessons from finishing",
      almost_one: "You are 1 lesson from finishing!",
      ...
      sum_title: "Catch me up",
      file_attach: "Attach a small file",
      file_reading: "Reading file…",
      file_big: "Too big ({n} KB). Max 200 KB — everyone downloads it.",
      file_type: "Only PDF, TXT, CSV, MD, JSON, ZIP, Word, Excel, PowerPoint",
      file_fail: "Could not read that file",
      sum_working: "Reading the conversation…",
      sum_msgs: "messages",
      sum_private: "Only you can see this summary.",
      sum_fail: "Could not summarise — try again",
      sum_noai: "AI is not available right now",
      sum_thin: "Not enough messages to summarise yet",
      chat_translating: "Translating…",
      chat_trans_fail: "Could not translate — try again",
      polish_title: "Polish my message",
      polish_fix: "✍️ Fix grammar",
      polish_en: "🇬🇧 Translate to English",
      polish_my: "🇲🇲 Translate to Burmese",
      polish_pro: "👔 Professional",
      polish_casual: "😊 Casual",
      polish_working: "Polishing…",
      polish_fail: "Could not polish — try again",
      ...
      nb_title: "My Notebook",
      ins_title: "Insights",
      sd_title: "What students search for",
      sd_clear: "Clear",
      sd_clearq: "Clear all recorded searches? This cannot be undone.",
      sd_clearing: "Clearing…",
      sd_top: "Most searched",
      sd_zero: "Searched but found NOTHING — courses you do not have yet",
      sd_hint: "These are literal requests. The biggest number is your next course.",
      sd_none: "No searches recorded yet. They appear here as students use the search box.",
      stu_title: "Students",
      stu_sub: "Who is actually learning — and who has gone quiet.",
      stu_total: "students",
      stu_finished: "finished a course",
      stu_quiet: "quiet 7+ days",
      stu_nobody: "Nobody has finished a course yet. Check Insights to see where they stop.",
      stu_name: "Name",
      stu_lessons: "Lessons",
      stu_courses: "Courses",
      stu_last: "Last seen",
      stu_today: "today",
      stu_yesterday: "yesterday",
      stu_days: "{n} days ago",
      stu_none: "No students yet. They appear here once they complete a lesson while signed in.",
      ins_sub: "Where students actually stop. Anonymous — no names, no ids.",
      ins_started: "started",
      ins_finished: "finished",
      ins_completion: "complete",
      ins_cliff: "Biggest drop-off at",
      ins_lost: "{n} students stopped here",
      ins_none: "No data yet",
      ins_none_sub: "Lesson completions are counted anonymously from now on. Come back once students have finished a few lessons. (Needs firebase-rules.json published.)",
      nb_sub: "Every note you have written, in one place.",
      nb_search: "Search your notes…",
      nb_open: "Open lesson",
      nb_export: "Export all",
      nb_all: "See all notes",
      nb_empty: "No notes yet. Write one in any lesson and it will appear here.",
      nb_none: "No notes match that search.",
      ...
      cert_verify_at: "Verify at",
      cert_verify_copy: "Copy verify link",
      vf_title: "Verify a certificate",
      vf_sub: "Employers: enter the certificate ID printed on a WebDev Academy certificate to confirm it's real.",
      vf_check: "Verify",
      vf_valid: "Valid certificate",
      vf_invalid: "Not found",
      vf_invalid_sub: "No certificate matches this ID. Check the ID and try again.",
      vf_issued_to: "Issued to",
      vf_course_w: "Course",
      vf_date_w: "Issued",

      cv_mine: "My CV",
      cv_title: "CV Builder",
      cv_sub: "Your finished courses, certificates and projects — assembled into a clean CV. Print it or save it as a PDF.",
      cv_print: "Print / Save PDF",
      cv_details: "Your details",
      cv_name: "Full name",
      cv_headline: "Headline",
      cv_headline_ph: "e.g. Junior Web Developer",
      cv_phone: "Phone",
      cv_location: "City",
      cv_links: "Links",
      cv_links_ph: "GitHub, Facebook page…",
      cv_about: "About me",
      cv_about_ph: "2-3 sentences about you and what you're looking for.",
      cv_skills_extra: "Extra skills",
      cv_skills_ph: "Comma separated — e.g. Photoshop, English",
      cv_edu: "Education",
      cv_edu_ph: "One per line — e.g. High School Diploma, BEHS (1) Yangon, 2024",
      cv_exp: "Experience",
      cv_exp_ph: "One per line — e.g. Shop assistant, family store, 2023–2024",
      cv_sec_about: "About",
      cv_sec_skills: "Skills",
      cv_sec_courses: "Courses & Certificates",
      cv_sec_projects: "Projects",
      cv_sec_edu: "Education",
      cv_sec_exp: "Experience",
      cv_in_progress: "in progress",
      cv_cert_w: "Certificate",
      cv_verify_w: "verify",
      cv_empty_hint: "Finish a course or save a project to your portfolio and it will appear here automatically.",

      iv_title: "Mock Interview",
      iv_sub: "Practice a real job interview with an AI interviewer — 5 questions, instant feedback, and a score at the end.",
      iv_pick_role: "Pick the job you want to practice for",
      iv_pick_lang: "Interview language",
      iv_start: "Start interview",
      iv_daily_note: "Free: 1 practice interview per day.",
      iv_daily_out: "You've used today's free interview. Come back tomorrow — or go Premium for unlimited practice.",
      iv_q_of: "Question {n}/{total}",
      iv_answer_ph: "Type your answer…",
      iv_send: "Answer",
      iv_done: "Interview finished",
      iv_score_w: "Score",
      iv_again: "Practice again",
      iv_quit: "End",
      iv_history: "Your past interviews",
      iv_err_retry: "Something went wrong — your answer was put back, try sending it again.",

      career_card_t: "Get ready for a real job",
      career_card_b: "Practice interviews with AI and build your CV",
      career_card_btn: "Try it",

      admin_all_courses: "All courses (built-in)",
      admin_all_courses_sub: "Open any built-in course in the editor. Saving stores your edited copy over the original — Reset brings the original back anytime.",
      admin_edited_builtin: "edited built-in",
      admin_reset: "Reset",
      admin_resetq: "Reset this course to the original built-in version? Your edited copy will be removed.",
      admin_kept_asis: "special lesson — kept as-is",

      chat_run_pg: "Run in Playground",
      chat_queued: "Queued — sends when you're back online",

      recap_title: "Your Week",
      recap_sub: "What you got done this week — and the one next step to keep going.",
      recap_card_t: "Your week so far",
      recap_card_b: "{l} lessons · +{x} XP this week",
      recap_card_btn: "See recap",
      recap_xp: "XP this week",
      recap_lessons: "Lessons",
      recap_due: "Cards due",
      recap_goal: "Weekly goal: {n} lessons",
      recap_goal_hit: "Weekly goal reached!",
      recap_msg_hot: "Amazing week — you're on fire!",
      recap_msg_ok: "Nice work this week — keep the momentum!",
      recap_msg_start: "A fresh week — do one lesson to get rolling.",
      recap_keep: "Keep going",
      recap_next: "Pick up where you left off",
      recap_share: "Share my week",
      recap_share_msg: "My week on WebDev Academy: {l} lessons, +{x} XP, {s}-day streak 🔥",

      xp_title: "Explore Open Source",
      xp_sub: "Real, famous projects on GitHub — see where your skills lead, and read real code.",
      xp_note: "Star counts refresh from GitHub when you're online.",
      xp_view: "GitHub ↗",
      xp_card_t: "Explore real open source",
      xp_card_b: "Famous GitHub projects, picked for learners",
      xp_card_btn: "Explore",
      plat_title: "Best interactive platforms",
      plat_sub: "Sites where you learn by doing — code in the browser and get instant feedback, just like here.",
      plat_visit: "Visit ↗",
      plat_free: "Free tier",
      cmdk_placeholder: "Search lessons, courses, tools…",
      cmdk_nav: "navigate",
      cmdk_open: "open",
      cmdk_none: "No matches",
      cmdk_kind_page: "Page",
      cmdk_kind_course: "Course",
      cmdk_kind_lesson: "Lesson",
      cmdk_kind_tool: "Tool",
      cmdk_kind_resource: "Resource",
      xcat_learn: "Learn",
      xcat_frontend: "Frontend",
      xcat_ai: "AI",
      xcat_projects: "Projects",
      xcat_tools: "Tools",

      home_hi: "Welcome back, {n}",
      home_hi_sub: "Ready for today's lesson?",
      home_continue: "Continue where you left off",
      home_start_course: "Start your course",
      home_get_started: "Get started",
      home_pick: "Pick up a new skill",
      home_pick_sub: "Fresh courses picked for you",
      why_ai_t: "AI tutor",
      why_ai_d: "Stuck? Ask in English or Burmese, anytime.",
      why_play_t: "Code playground",
      why_play_d: "Write and run real code right in your browser.",
      why_cert_t: "Real certificates",
      why_cert_d: "Finish a course and earn a verifiable certificate.",

      track_web: "Web Developer",
      track_da: "Data Analyst",
      da_intro: "Not taught here yet — this is a curated path to become a Data Analyst, using the best free and paid resources on the web.",
      da_s1_t: "Spreadsheets", da_s1_s: "Master Pivot Tables, VLOOKUP/XLOOKUP and basic data cleaning.",
      da_s2_t: "SQL Databases", da_s2_s: "Query, filter, join and aggregate data from relational databases.",
      da_s3_t: "BI Dashboards", da_s3_s: "Build interactive dashboards with Power BI or Tableau.",
      da_s4_t: "Programming", da_s4_s: "Use Pandas, NumPy & Matplotlib to manipulate data and automate workflows.",
      da_core: "Recommended core courses",
      da_freebudget: "Free & budget-friendly",
      da_open: "Open",
      da_free: "Free", da_paid: "Paid",
      da_tag_beginner: "Beginner", da_tag_hands: "Hands-on", da_tag_bi: "Power BI", da_tag_free: "Free",
      da_r_google: "Beginner-friendly, widely recognized cert — Sheets, SQL, Tableau, R. Teaches the full Ask→Prepare→Analyze→Share process.",
      da_r_datacamp: "Interactive, in-browser coding with real portfolio projects. SQL and Python (Pandas, Seaborn).",
      da_r_ms: "For BI & corporate roles — Advanced Excel, SQL, Power BI, DAX. Preps the PL-300 exam.",
      da_r_alex: "A popular free, structured curriculum: SQL, Excel, Tableau, Power BI and Python basics.",
      da_r_fcc: "Completely free, hands-on Python + Pandas training with interactive projects.",
      da_r_kaggle: "Free short courses with hands-on coding for Python, SQL and Data Visualization.",
      da_note: "External links open in a new tab. WebDev Academy isn't affiliated with these providers.",
    },
    my: {
      ...
      ht_all: "အားလုံး",
      ht_try: "စမ်းကြည့်",
      onb1_t: "WebDev Academy မှ ကြိုဆိုပါတယ်! 👋",
      onb1_b: "ကုဒ်ရေးတာ အခမဲ့ သင်ယူပါ — မြန်မာ + English၊ ဖုန်းထဲမှာပဲ။",
      onb2_t: "လက်တွေ့လုပ်ရင်း သင်ယူပါ",
      onb2_b: "ကုဒ်ကို နေရာမှာတင် run/edit လုပ်လို့ရတဲ့ သင်ခန်းစာအစစ်တွေ — quiz တွေနဲ့ ပိတ်နေရင် AI ဆရာပါ။",
      onb3_t: "နေ့စဉ် အလေ့အကျင့် တည်ဆောက်ပါ",
      onb3_b: "XP ရယူပါ၊ streak 🔥 ထိန်းပါ၊ Daily Review က သင်ခန်းစာတွေ ပြန်ခေါ်ပေးလို့ အမြဲစွဲမြဲစေတယ်။",
      onb4_t: "Certificate အစစ် ရယူပါ 🎓",
      onb4_b: "သင်တန်းတစ်ခု ပြီးရင် certificate ဖွင့်ရမယ်။ ဘယ်ကနေ စရမလဲ ရှာကြည့်မလား?",
      onb_goal_q: "တစ်ပတ်ကို သင်ခန်းစာ ဘယ်နှစ်ခု?",
      onb_next: "ရှေ့ဆက်",
      onb_skip: "ကျော်ရန်",
      onb_cta_quiz: "ကျွန်ုပ့်သင်တန်း ရှာရန် (၁ မိနစ် quiz)",
      onb_cta_browse: "သင်တန်းအားလုံး ကြည့်ရန်",
      ...
      pg_explain: "ဒီ error ကို ရှင်းပြပါ",
      pg_explain_working: "error ကို ဖတ်နေသည်…",
      focus_mode: "အာရုံစိုက်",
      focus_exit: "ထွက်ရန်",
      focus_hint: "အနှောင့်အယှက်ကင်း ဖတ်ရှုမှု (ထွက်ရန် Esc)",
      nm_learn: "သင်ယူရန်",
      nm_build: "တည်ဆောက်ရန်",
      nm_community: "အသိုင်းအဝိုင်း",
      nm_me: "ကျွန်ုပ်",
      nm_courses: "သင်တန်းများ",
      nm_gallery: "သင်တန်း ပြခန်း",
      nm_roadmap: "လမ်းကြောင်း",
      nm_start: "ကျွန်ုပ်၏ သင်တန်းရှာရန်",
      nm_howto: "How-To",
      nm_daily: "နေ့စဉ် စိန်ခေါ်မှု",
      nm_review: "ပြန်လှန်လေ့ကျင့်ခန်း",
      nm_playground: "စမ်းသပ်ခန်း",
      nm_tools: "ကိရိယာများ",
      nm_notes: "ကျွန်ုပ်၏ မှတ်စု",
      nm_portfolio: "Portfolio",
      nm_cv: "CV တည်ဆောက်ရန်",
      nm_interview: "Interview လေ့ကျင့်ခန်း",
      nm_trending: "ခေတ်စား",
      nm_chat: "အသိုင်းအဝိုင်း စကားပြော",
      nm_leaderboard: "အဆင့်ဇယား",
      nm_battle: "ကုဒ် ပြိုင်ပွဲ",
      nm_explore: "Open Source လေ့လာရန်",
      nm_mylearning: "ကျွန်ုပ်၏သင်ယူမှု",
      nm_recap: "သင့်တစ်ပတ်တာ",
      nm_account: "အကောင့်",
      nm_premium: "Premium အသင်းဝင်ရန်",
      nm_verify: "လက်မှတ် စစ်ဆေးရန်",
      chat_search: "စာများ ရှာရန်",
      chat_search_ph: "ဤအခန်းတွင် ရှာရန်…",
      chat_search_clear: "ရှာဖွေမှု ရှင်းရန်",
      chat_search_n: "{n} ခု တွေ့သည်",
      chat_search_none: "ကိုက်ညီသော စာ မရှိပါ",
      chat_save: "စာ သိမ်းရန်",
      chat_unsave: "သိမ်းထားမှု ဖယ်ရန်",
      chat_saved: "သိမ်းထားသော စာများ",
      chat_saved_none: "သိမ်းထားသည် မရှိသေးပါ — စာတစ်ခုတွင် 🔖 ကို နှိပ်ပါ။",
      chat_more_menu: "နောက်ထပ် ရွေးချယ်စရာ",
      chat_close: "စကားပြော ပိတ်ရန်",
      chat_full: "မျက်နှာပြင် အပြည့်",
      chat_full_exit: "မျက်နှာပြင်အပြည့် ထွက်ရန်",
      chat_online_n: "{n} ယောက် အွန်လိုင်း",
      ...
      tool_cheats: "Cheat Sheet များ", tool_cheats_d: "HTML, CSS, JS, Python, Git, SQL, HTTP, Regex, Emmet — command တိုင်းကို ရှာ၊ တစ်ချက်နှိပ်ကူးပါ။",
      cheat_search: "ဒီစာရွက်ထဲ ရှာရန်…",
      cheat_matches: "ခု တွေ့သည်",
      cheat_none: "ဤစာရွက်ထဲ ရှာမတွေ့ပါ။",
      ...
      tool_boxmodel: "Box Model Lab", tool_boxmodel_d: "margin, border, padding, content ကို အရောင်များဖြင့် မြင်နိုင်သည် — slider ဆွဲပြီး box ပြောင်းလဲတာကို ချက်ချင်းကြည့်ပါ။",
      tl_bm_total: "မျက်နှာပြင်ပေါ်မှ အရွယ်အစား (width + padding + border)",
      ...
      aimg_title: "AI ပုံ",
      aimg_sub: "အခမဲ့ — စိတ်ကူးရိုက်ထည့်ရုံနဲ့ ပုံရမယ် (key မလို၊ ကုန်ကျစရာမရှိ)",
      aimg_ph: "ပုံကို ဖော်ပြပါ — ဥပမာ ကုဒ်သင်နေတဲ့ cartoon laptop",
      aimg_need: "အရင် ဖော်ပြချက် ရိုက်ထည့်ပါ!",
      aimg_making: "ပုံ ဆွဲနေသည်… (စက္ကန့်အနည်းငယ်)",
      aimg_done: "ပြီးပါပြီ — right-click / ဖိထားပြီး သိမ်းပါ",
      vid_thumb_ready: "thumbnail idea အောက်မှာ ဖြည့်ပြီး — 🎨 Generate နှိပ်ပါ",
      ...
      simple_points: "ရိုးရှင်းစွာ ရှင်းပြ",
      ...
      proj_word: "ပရောဂျက်",
      proj_submit: "စစ်ဆေးရန် တင်ပြမည်",
      proj_reviewing: "သင့်ဆရာက သင့်ကုဒ်ကို စစ်ဆေးနေသည်…",
      proj_feedback: "ဆရာ့ အကြံပြုချက်",
      proj_saved: "သင့် Portfolio ထဲ သိမ်းလိုက်ပြီ!",
      proj_saved_go: "Portfolio ထဲတွင် ကြည့်ရန်",
      proj_pick: "တည်ဆောက်ရန် ပရောဂျက်တစ်ခု ရွေးပါ",
      proj_run: "ဖွင့်ကြည့်",
      proj_edit: "ပြင်ရန်",
      course_project: "ပရောဂျက် တည်ဆောက်မည်",
      portfolio_mine: "ကျွန်ုပ်၏ Portfolio",
      portfolio_title: "Portfolio",
      portfolio_sub: "သင်တကယ်တည်ဆောက်ခဲ့သော ပရောဂျက်များ — သင့်စွမ်းရည်၏ သက်သေ။",
      portfolio_share: "ကျွန်ုပ်၏ Portfolio ကို မျှဝေရန်",
      portfolio_empty: "ပရောဂျက် မရှိသေးပါ။ ပထမဆုံးတစ်ခု တည်ဆောက်ကြည့်ပါ!",
      portfolio_empty_pub: "ဤ Portfolio တွင် လောလောဆယ် ဘာမှမရှိသေးပါ။",
      portfolio_start: "ပရောဂျက် စတင်ရန်",
      showcase_title: "ပြပွဲ",
      showcase_sub: "သင့်လိုပဲ ကျောင်းသားတွေ တကယ်တည်ဆောက်ထားတဲ့ ပရောဂျက်များ။ လှုံ့ဆော်မှုယူပြီး သင့်ဟာကိုလည်း တည်ဆောက်ပါ။",
      showcase_build: "သင့်ဟာ တည်ဆောက်ရန်",
      showcase_browse: "ပြပွဲ ကြည့်ရန်",
      showcase_empty: "မျှဝေထားသော ပရောဂျက် မရှိသေးပါ။ ပထမဆုံး တင်ပြသူ ဖြစ်လိုက်ပါ!",
      by_word: "—",
      trending_word: "ခေတ်စား",
      newest_word: "အသစ်ဆုံး",
      chat_trending: "ခေတ်စား",
      ...
      almost_n: "ပြီးဆုံးရန် သင်ခန်းစာ {n} ခုသာ ကျန်တော့သည်",
      almost_one: "ပြီးဆုံးရန် သင်ခန်းစာ ၁ ခုသာ ကျန်တော့သည်!",
      ...
      chat_more: "နောက်ထပ်",
      chat_translate: "ဘာသာပြန်ရန်",
      sum_title: "အကျဉ်းချုပ် ဖတ်ရန်",
      file_attach: "ဖိုင်ငယ် ပူးတွဲရန်",
      file_reading: "ဖိုင် ဖတ်နေသည်…",
      file_big: "ကြီးလွန်းသည် ({n} KB)။ အများဆုံး 200 KB။",
      file_type: "PDF, TXT, CSV, MD, JSON, ZIP, Word, Excel, PowerPoint သာ",
      file_fail: "ဖိုင်ကို ဖတ်၍မရပါ",
      sum_working: "စကားဝိုင်းကို ဖတ်နေသည်…",
      sum_msgs: "မက်ဆေ့ချ်",
      sum_private: "ဤအကျဉ်းချုပ်ကို သင်တစ်ဦးတည်းသာ မြင်ရသည်။",
      sum_fail: "အကျဉ်းချုပ်၍မရပါ — ထပ်စမ်းပါ",
      sum_noai: "AI ကို ယခုအသုံးမပြုနိုင်ပါ",
      sum_thin: "အကျဉ်းချုပ်ရန် မက်ဆေ့ချ် မလုံလောက်ပါ",
      chat_translating: "ဘာသာပြန်နေသည်…",
      chat_trans_fail: "ဘာသာပြန်၍မရပါ — ထပ်စမ်းပါ",
      polish_title: "စာသားကို ပြင်ဆင်ရန်",
      polish_fix: "✍️ သဒ္ဒါ ပြင်ရန်",
      polish_en: "🇬🇧 အင်္ဂလိပ်လို ပြန်ရန်",
      polish_my: "🇲🇲 မြန်မာလို ပြန်ရန်",
      polish_pro: "👔 ရုံးသုံး",
      polish_casual: "😊 ရင်းနှီး",
      polish_working: "ပြင်ဆင်နေသည်…",
      polish_fail: "မရပါ — ထပ်စမ်းကြည့်ပါ",
      ...
      nb_title: "ကျွန်ုပ်၏ မှတ်စုစာအုပ်",
      ins_title: "ခွဲခြမ်းစိတ်ဖြာချက်",
      sd_title: "ကျောင်းသားများ ရှာဖွေသည့်အရာ",
      sd_clear: "ရှင်းရန်",
      sd_clearq: "ရှာဖွေမှု မှတ်တမ်းအားလုံး ဖျက်မလား? ပြန်ယူ၍မရပါ။",
      sd_clearing: "ရှင်းနေသည်…",
      sd_top: "အများဆုံး ရှာဖွေမှု",
      sd_zero: "ရှာသော်လည်း မတွေ့ပါ — မရှိသေးသော သင်တန်းများ",
      sd_hint: "ဤသည်မှာ တောင်းဆိုချက်များဖြစ်သည်။ အများဆုံးမှာ သင့်နောက်သင်တန်းဖြစ်သည်။",
      sd_none: "ရှာဖွေမှု မှတ်တမ်း မရှိသေးပါ။",
      stu_title: "ကျောင်းသားများ",
      stu_sub: "မည်သူတကယ်လေ့လာနေသနည်း — မည်သူ တိတ်ဆိတ်သွားသနည်း။",
      stu_total: "ကျောင်းသား",
      stu_finished: "သင်တန်းပြီးဆုံး",
      stu_quiet: "၇ ရက်+ တိတ်ဆိတ်",
      stu_nobody: "မည်သူမျှ သင်တန်းတစ်ခုမှ မပြီးဆုံးသေးပါ။",
      stu_name: "အမည်",
      stu_lessons: "သင်ခန်းစာ",
      stu_courses: "သင်တန်း",
      stu_last: "နောက်ဆုံးတွေ့",
      stu_today: "ယနေ့",
      stu_yesterday: "မနေ့က",
      stu_days: "{n} ရက်က",
      stu_none: "ကျောင်းသား မရှိသေးပါ။",
      ins_sub: "ကျောင်းသားများ တကယ်ရပ်တန့်သွားသည့်နေရာ။ အမည်မဖော်ပါ။",
      ins_started: "စတင်",
      ins_finished: "ပြီးဆုံး",
      ins_completion: "ပြီးစီး",
      ins_cliff: "အများဆုံး ရပ်တန့်သည့်နေရာ",
      ins_lost: "ကျောင်းသား {n} ဦး ဤနေရာတွင် ရပ်သွားသည်",
      ins_none: "ဒေတာ မရှိသေးပါ",
      ins_none_sub: "သင်ခန်းစာ ပြီးဆုံးမှုများကို ယခုမှစ၍ အမည်မဖော်ဘဲ ရေတွက်ပါမည်။",
      nb_sub: "သင်ရေးထားသော မှတ်စုအားလုံး တစ်နေရာတည်းတွင်။",
      nb_search: "မှတ်စုများ ရှာရန်…",
      nb_open: "သင်ခန်းစာ ဖွင့်ရန်",
      nb_export: "အားလုံး ထုတ်ယူရန်",
      nb_all: "မှတ်စုအားလုံး ကြည့်ရန်",
      nb_empty: "မှတ်စု မရှိသေးပါ။ သင်ခန်းစာတစ်ခုတွင် ရေးလိုက်ပါက ဤနေရာတွင် ပေါ်လာပါမည်။",
      nb_none: "ရှာဖွေမှုနှင့် ကိုက်ညီသော မှတ်စု မရှိပါ။",
      ...
      cert_verify_at: "စစ်ဆေးရန် —",
      cert_verify_copy: "စစ်ဆေးလင့်ခ် ကူးရန်",
      vf_title: "Certificate စစ်ဆေးရန်",
      vf_sub: "အလုပ်ရှင်များ — WebDev Academy certificate ပေါ်မှ လက်မှတ်နံပါတ်ကို ရိုက်ထည့်ပြီး အစစ်အမှန်ဖြစ်ကြောင်း စစ်ဆေးနိုင်ပါတယ်။",
      vf_check: "စစ်ဆေးမည်",
      vf_valid: "Certificate အစစ်အမှန်",
      vf_invalid: "ရှာမတွေ့ပါ",
      vf_invalid_sub: "ဒီနံပါတ်နဲ့ ကိုက်ညီတဲ့ certificate မရှိပါ။ နံပါတ်ကို ပြန်စစ်ပြီး ထပ်စမ်းကြည့်ပါ။",
      vf_issued_to: "ပေးအပ်ထားသူ",
      vf_course_w: "သင်တန်း",
      vf_date_w: "ထုတ်ပေးသည့်ရက်",

      cv_mine: "ကျွန်ုပ်၏ CV",
      cv_title: "CV တည်ဆောက်ရန်",
      cv_sub: "ပြီးမြောက်ထားတဲ့ သင်တန်းများ၊ certificate များနဲ့ project များကို သပ်ရပ်တဲ့ CV တစ်စောင်အဖြစ် စုစည်းပေးတယ် — Print လုပ်ပါ သို့မဟုတ် PDF အဖြစ်သိမ်းပါ။",
      cv_print: "Print / PDF သိမ်းရန်",
      cv_details: "သင့်အချက်အလက်များ",
      cv_name: "အမည်အပြည့်အစုံ",
      cv_headline: "ရာထူးခေါင်းစဉ်",
      cv_headline_ph: "ဥပမာ — Junior Web Developer",
      cv_phone: "ဖုန်း",
      cv_location: "မြို့",
      cv_links: "လင့်ခ်များ",
      cv_links_ph: "GitHub, Facebook page…",
      cv_about: "ကျွန်ုပ်အကြောင်း",
      cv_about_ph: "သင်နဲ့ သင်ရှာနေတဲ့အလုပ်အကြောင်း စာကြောင်း ၂-၃ ကြောင်း။",
      cv_skills_extra: "အခြားကျွမ်းကျင်မှုများ",
      cv_skills_ph: "Comma ခြားရေးပါ — ဥပမာ Photoshop, English",
      cv_edu: "ပညာရေး",
      cv_edu_ph: "တစ်ကြောင်းစီ — ဥပမာ အထက်တန်းအောင်၊ အ.ထ.က (၁) ရန်ကုန်၊ ၂၀၂၄",
      cv_exp: "အတွေ့အကြုံ",
      cv_exp_ph: "တစ်ကြောင်းစီ — ဥပမာ ဆိုင်အကူ၊ မိသားစုဆိုင်၊ ၂၀၂၃–၂၀၂၄",
      cv_sec_about: "မိမိအကြောင်း",
      cv_sec_skills: "ကျွမ်းကျင်မှုများ",
      cv_sec_courses: "သင်တန်းများနှင့် Certificate များ",
      cv_sec_projects: "Project များ",
      cv_sec_edu: "ပညာရေး",
      cv_sec_exp: "အတွေ့အကြုံ",
      cv_in_progress: "သင်ယူနေဆဲ",
      cv_cert_w: "Certificate",
      cv_verify_w: "စစ်ဆေးရန်",
      cv_empty_hint: "သင်တန်းတစ်ခု ပြီးအောင်လုပ်ပါ သို့မဟုတ် project တစ်ခုကို portfolio ထဲသိမ်းပါ — ဒီမှာ အလိုအလျောက် ပေါ်လာပါမယ်။",

      iv_title: "Interview လေ့ကျင့်ခန်း",
      iv_sub: "AI interviewer နဲ့ အလုပ် interview အစစ်လို လေ့ကျင့်ပါ — မေးခွန်း ၅ ခု၊ ချက်ချင်း feedback နဲ့ အဆုံးမှာ အမှတ်ပေးပါမယ်။",
      iv_pick_role: "လေ့ကျင့်ချင်တဲ့ အလုပ်ကို ရွေးပါ",
      iv_pick_lang: "Interview ဘာသာစကား",
      iv_start: "Interview စတင်မည်",
      iv_daily_note: "အခမဲ့ — တစ်နေ့ interview ၁ ကြိမ်။",
      iv_daily_out: "ဒီနေ့အတွက် အခမဲ့ interview သုံးပြီးပါပြီ။ မနက်ဖြန် ပြန်လာပါ — သို့မဟုတ် အကန့်အသတ်မရှိ လေ့ကျင့်ဖို့ Premium ယူပါ။",
      iv_q_of: "မေးခွန်း {n}/{total}",
      iv_answer_ph: "သင့်အဖြေ ရိုက်ထည့်ပါ…",
      iv_send: "ဖြေမည်",
      iv_done: "Interview ပြီးပါပြီ",
      iv_score_w: "အမှတ်",
      iv_again: "ထပ်လေ့ကျင့်မည်",
      iv_quit: "ရပ်မည်",
      iv_history: "ယခင် interview များ",
      iv_err_retry: "တစ်ခုခု မှားသွားပါတယ် — သင့်အဖြေကို ပြန်ထည့်ပေးထားပါတယ်၊ ထပ်ပို့ကြည့်ပါ။",

      career_card_t: "အလုပ်အစစ်အတွက် ပြင်ဆင်ပါ",
      career_card_b: "AI နဲ့ interview လေ့ကျင့်ပြီး CV တည်ဆောက်ပါ",
      career_card_btn: "စမ်းကြည့်",

      admin_all_courses: "သင်တန်းအားလုံး (built-in)",
      admin_all_courses_sub: "Built-in သင်တန်းတိုင်းကို editor ထဲမှာ ဖွင့်ပြီး ပြင်နိုင်သည်။ သိမ်းလိုက်ရင် သင်ပြင်ထားတဲ့မိတ္တူက မူရင်းနေရာမှာ အစားထိုးဝင်မယ် — Reset နှိပ်ရင် မူရင်း ပြန်လာမယ်။",
      admin_edited_builtin: "ပြင်ထားသော built-in",
      admin_reset: "မူရင်းပြန်ထား",
      admin_resetq: "ဒီသင်တန်းကို မူရင်း built-in ဗားရှင်းသို့ ပြန်ထားမလား? သင်ပြင်ထားတဲ့မိတ္တူ ဖျက်ပစ်ပါမယ်။",
      admin_kept_asis: "အထူးသင်ခန်းစာ — အတိုင်းထားမည်",

      chat_run_pg: "Playground မှာ Run မည်",
      chat_queued: "စောင့်ဆိုင်းထား — အင်တာနက်ပြန်ရရင် အလိုအလျောက် ပို့ပါမယ်",

      recap_title: "သင့်တစ်ပတ်တာ",
      recap_sub: "ဒီတစ်ပတ် သင်လုပ်ဆောင်ခဲ့တာနဲ့ ဆက်လုပ်ရန် နောက်တစ်ဆင့်။",
      recap_card_t: "ဒီတစ်ပတ် သင့်တိုးတက်မှု",
      recap_card_b: "သင်ခန်းစာ {l} ခု · ဒီတစ်ပတ် +{x} XP",
      recap_card_btn: "recap ကြည့်ရန်",
      recap_xp: "ဒီတစ်ပတ် XP",
      recap_lessons: "သင်ခန်းစာ",
      recap_due: "ပြန်လှန်ရန် ကတ်",
      recap_goal: "တစ်ပတ်ပန်းတိုင်: သင်ခန်းစာ {n} ခု",
      recap_goal_hit: "တစ်ပတ်ပန်းတိုင် ပြည့်ပြီ!",
      recap_msg_hot: "အံ့သြစရာ တစ်ပတ်ပါ — အရှိန်ကောင်းနေတယ်!",
      recap_msg_ok: "ဒီတစ်ပတ် ကောင်းတယ် — အရှိန်ဆက်ထိန်းပါ!",
      recap_msg_start: "တစ်ပတ်သစ် — သင်ခန်းစာတစ်ခုနဲ့ စလိုက်ပါ။",
      recap_keep: "ဆက်လုပ်ပါ",
      recap_next: "ရပ်ထားတဲ့နေရာက ဆက်လုပ်ပါ",
      recap_share: "တစ်ပတ်တာ မျှဝေမည်",
      recap_share_msg: "WebDev Academy မှာ ကျွန်ုပ်တစ်ပတ်တာ: သင်ခန်းစာ {l} ခု, +{x} XP, {s} ရက် streak 🔥",

      xp_title: "Open Source လေ့လာရန်",
      xp_sub: "GitHub ပေါ်က ကျော်ကြားတဲ့ project အစစ်များ — သင့်ကျွမ်းကျင်မှုက ဘယ်ကိုသွားလဲ ကြည့်ပြီး code အစစ် ဖတ်ပါ။",
      xp_note: "Star အရေအတွက်ကို online ဖြစ်ချိန် GitHub မှ အသစ်ဆွဲပါတယ်။",
      xp_view: "GitHub ↗",
      xp_card_t: "Open source အစစ် လေ့လာပါ",
      xp_card_b: "သင်ယူသူများအတွက် ရွေးထားတဲ့ ကျော်ကြား GitHub project များ",
      xp_card_btn: "လေ့လာရန်",
      plat_title: "အကောင်းဆုံး interactive platform များ",
      plat_sub: "လက်တွေ့လုပ်ရင်း သင်ယူတဲ့ site များ — browser ထဲမှာ code ရေးပြီး ချက်ချင်း feedback ရ၊ ဒီလိုပဲ။",
      plat_visit: "သွားရန် ↗",
      plat_free: "အခမဲ့ tier",
      cmdk_placeholder: "သင်ခန်းစာ၊ သင်တန်း၊ tool ရှာရန်…",
      cmdk_nav: "ရွှေ့ရန်",
      cmdk_open: "ဖွင့်ရန်",
      cmdk_none: "ရှာမတွေ့ပါ",
      cmdk_kind_page: "စာမျက်နှာ",
      cmdk_kind_course: "သင်တန်း",
      cmdk_kind_lesson: "သင်ခန်းစာ",
      cmdk_kind_tool: "Tool",
      cmdk_kind_resource: "Resource",
      xcat_learn: "သင်ယူ",
      xcat_frontend: "Frontend",
      xcat_ai: "AI",
      xcat_projects: "Project",
      xcat_tools: "Tools",

      home_hi: "ပြန်လည်ကြိုဆိုပါတယ်၊ {n}",
      home_hi_sub: "ဒီနေ့ သင်ခန်းစာအတွက် အသင့်ဖြစ်ပြီလား?",
      home_continue: "ရပ်ထားတဲ့နေရာက ဆက်လုပ်ပါ",
      home_start_course: "သင်တန်း စတင်ပါ",
      home_get_started: "စတင်ရန်",
      home_pick: "ကျွမ်းကျင်မှုအသစ် တစ်ခု စတင်ပါ",
      home_pick_sub: "သင့်အတွက် ရွေးထားတဲ့ သင်တန်းအသစ်များ",
      why_ai_t: "AI ဆရာ",
      why_ai_d: "ပိတ်နေလား? English ဒါမှမဟုတ် မြန်မာလို အချိန်မရွေး မေးပါ။",
      why_play_t: "Code Playground",
      why_play_d: "Browser ထဲမှာတင် ကုဒ်အစစ် ရေး၊ run ပါ။",
      why_cert_t: "Certificate အစစ်",
      why_cert_d: "သင်တန်းပြီးရင် စစ်ဆေးနိုင်တဲ့ certificate ရယူပါ။",

      track_web: "Web Developer",
      track_da: "Data Analyst",
      da_intro: "ဒီမှာ မသင်ရသေးပါ — Data Analyst ဖြစ်ဖို့ အင်တာနက်ပေါ်က အကောင်းဆုံး အခမဲ့နဲ့ အခပေး resource များနဲ့ ရွေးချယ်ထားတဲ့ လမ်းကြောင်းပါ။",
      da_s1_t: "Spreadsheets", da_s1_s: "Pivot Table, VLOOKUP/XLOOKUP နဲ့ အခြေခံ data cleaning ကို ကျွမ်းအောင်လုပ်ပါ။",
      da_s2_t: "SQL Databases", da_s2_s: "relational database များမှ data ကို query, filter, join နဲ့ aggregate လုပ်ပါ။",
      da_s3_t: "BI Dashboards", da_s3_s: "Power BI သို့မဟုတ် Tableau နဲ့ interactive dashboard များ တည်ဆောက်ပါ။",
      da_s4_t: "Programming", da_s4_s: "Pandas, NumPy, Matplotlib နဲ့ data ကို ကိုင်တွယ်ပြီး workflow များ အလိုအလျောက်လုပ်ပါ။",
      da_core: "အကြံပြု အဓိက သင်တန်းများ",
      da_freebudget: "အခမဲ့ & သက်သာသော",
      da_open: "ဖွင့်ရန်",
      da_free: "အခမဲ့", da_paid: "အခပေး",
      da_tag_beginner: "အခြေခံ", da_tag_hands: "လက်တွေ့", da_tag_bi: "Power BI", da_tag_free: "အခမဲ့",
      da_r_google: "အခြေခံသူများအတွက် အသိအမှတ်ပြု cert — Sheets, SQL, Tableau, R။ Ask→Prepare→Analyze→Share အဆင့်အားလုံး သင်ပေးတယ်။",
      da_r_datacamp: "browser ထဲမှာ အပြန်အလှန် coding နဲ့ portfolio project အစစ်များ။ SQL နဲ့ Python (Pandas, Seaborn)။",
      da_r_ms: "BI နဲ့ corporate အလုပ်များအတွက် — Advanced Excel, SQL, Power BI, DAX။ PL-300 စာမေးပွဲ ပြင်ဆင်ပေးတယ်။",
      da_r_alex: "လူကြိုက်များတဲ့ အခမဲ့ curriculum: SQL, Excel, Tableau, Power BI နဲ့ Python အခြေခံ။",
      da_r_fcc: "လုံးဝအခမဲ့၊ လက်တွေ့ Python + Pandas သင်တန်း project များနဲ့။",
      da_r_kaggle: "Python, SQL, Data Viz အတွက် လက်တွေ့ coding နဲ့ အခမဲ့ သင်ခန်းစာတိုများ။",
      da_note: "ပြင်ပ link များကို tab အသစ်တွင် ဖွင့်ပါမည်။ WebDev Academy သည် ဤ provider များနှင့် ဆက်စပ်မှုမရှိပါ။",
    },
  },
