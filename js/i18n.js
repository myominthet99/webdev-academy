...
window.I18N = {
  ui: {
    en: {
      ...
      auth_reset_sent: "Done! If that email has an account, a reset link is on its way. Check your inbox (and spam).",
    ...
    my: {
      ...
      auth_reset_sent: "ပြီးပါပြီ! ထိုအီးမေးလ်တွင် အကောင့်ရှိပါက ပြန်သတ်မှတ်လင့်ခ် ရောက်လာပါမည်။ Inbox (နှင့် spam) ကိုစစ်ပါ။",
